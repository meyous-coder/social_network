                    ...
                    <ul class="dropdown-menu">
                        ...
                        <?php if (is_logged_in()): ?>
                            <li class="<?= set_active("profile") ?>"><a
                                    href="profile.php?id=<?= get_session("user_id") ?>"><?= $menu['mon_profil'][get_current_locale()] ?></a></li>
                            <li class="<?= set_active("share_code") ?>"><a href="share_code.php"><?= $menu['share_code'][get_current_locale()] ?></a></li>
                            <li role="separator" class="divider"></li>
                            <li class="<?= set_active("logout") ?>"><a href="logout.php"><?= $menu['deconnexion'][get_current_locale()] ?></a></li>
                        <?php else: ?>
                            <li class="<?= set_active("register") ?>"><a href="register.php"><?= $menu['inscription'][get_current_locale()] ?></a></li>
                            <li class="<?= set_active("login") ?>"><a href="login.php"><?= $menu['connexion'][get_current_locale()] ?></a></li>
                        <?php endif; ?>
